...
def load_data():
    zero_edge_index = pd.read_csv('./data/web-EPA/edge_2hop2tier_tier_0.txt', sep='\t', names=['s', 't']).T.astype(int)
    one_edge_index = pd.read_csv('./data/web-EPA/edge_2hop2tier_tier_1.txt', sep='\t', names=['s', 't']).T.astype(int)
    two_edge_index = pd.read_csv('./data/web-EPA/edge_2hop2tier_tier_2.txt', sep='\t', names=['s', 't']).T
    edge_weights = pd.read_csv('./data/web-EPA/whole_edge_dist.csv', sep=',', header=0).astype(float)
    hop_edge_dist = pd.read_csv('./data/web-EPA/whole_edge_hop_dist.csv', sep=',', header=0).astype(float)
    node_feats = pd.read_csv('./data/web-EPA/feature_2hop2tier.txt', sep='\t',header=None, index_col=0).astype(float)
